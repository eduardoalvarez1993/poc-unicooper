const defaults = {
  ...
  agreements: [
    { name: "Consultórios Belo Horizonte", section: "Convênios que aceitam cobrança de atendimentos em consultórios", category: "Consultórios", city: "Belo Horizonte", unit: "Consultório médico", imageUrl: "", description: "Atendimentos em consultórios com cobrança orientada pela Unicooper.", rules: "Confirme autorização, elegibilidade e regras de retorno antes do atendimento.", link: "https://unicooper.coop.br/convenios/", active: true },
    { name: "Belo Horizonte / Betim", section: "Convênios faturados pela Unicooper - Belo Horizonte / Betim", category: "Faturamento", city: "Belo Horizonte e Betim", unit: "Unidades conveniadas", imageUrl: "", description: "Convênios faturados pela Unicooper nas unidades de Belo Horizonte e Betim.", rules: "Acompanhe regras de autorização, retorno e auditoria conforme cada operadora.", link: "https://unicooper.coop.br/convenios/", active: true },
    { name: "Nova Lima", section: "Convênios faturados pela Unicooper - Nova Lima", category: "Faturamento", city: "Nova Lima", unit: "Unidades conveniadas", imageUrl: "", description: "Convênios faturados pela Unicooper na unidade de Nova Lima.", rules: "Verifique previamente regras operacionais e documentação necessária.", link: "https://unicooper.coop.br/convenios/", active: true },
    { name: "Salvador", section: "Convênios faturados pela Unicooper - Salvador", category: "Faturamento", city: "Salvador", unit: "Unidades conveniadas", imageUrl: "", description: "Convênios faturados pela Unicooper na unidade de Salvador.", rules: "Consulte particularidades de autorização e auditoria por unidade.", link: "https://unicooper.coop.br/convenios/", active: true },
    { name: "Instrumentação cirúrgica", section: "Convênios que permitem instrumentação cirúrgica", category: "Procedimentos", city: "Conforme operadora", unit: "Centro cirúrgico", imageUrl: "", description: "Convênios que permitem cobrança de instrumentação cirúrgica.", rules: "Algumas operadoras exigem verificação prévia com antecedência mínima.", link: "https://unicooper.coop.br/convenios/", active: true },
    { name: "Auditoria in loco", section: "Convênios que necessitam de auditoria in loco", category: "Auditoria", city: "Betim, Salvador e demais unidades", unit: "Unidades com auditoria", imageUrl: "", description: "Convênios que necessitam de auditoria presencial antes da finalização do fluxo.", rules: "Observe prazos e exigências de cada unidade antes do envio.", link: "https://unicooper.coop.br/convenios/", active: true }
  ],
  calendar: [
